...
- (void)didLoadFromCCB
{
    ...
    //die
    self.dieAction=[CCActionMoveBy actionWithDuration:2 position:ccp(0,500)];
...
-(void) eatstars
{
    ...
    if(self.eatenstar!=0&&self.eatenstar%10==0)
        self.can_rush++;
    if(self.can_rush>0&&_Pstatus!=Rush_nofish)
